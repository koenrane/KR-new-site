...
lw-linkpost-url: https://www.lesswrong.com/posts/NMfQFubXAQda4Y5fe/confounded-no-longer-insights-from-all-of-statistics
...
next-post-slug: into-the-kiln-insights-from-tao-s-analysis-i
...
The continuity is the culprit. Since the cumulative density functions  $F_X,F_Y$ are continuous, the limit of the density allotted to any given point is 0. Read more [here](#32607).
