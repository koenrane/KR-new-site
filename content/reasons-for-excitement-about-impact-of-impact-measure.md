...
lw-linkpost-url: https://www.lesswrong.com/posts/wAAvP8RG6EwzCvHJy/reasons-for-excitement-about-impact-of-impact-measure
...
I think there’s a decent chance there _isn’t_ a simple airtight way to implement AUP which lines up with AUP$_\text{conceptual}$ , mostly because it’s just incredibly difficult in general to perfectly specify the reward function.
...
2.  If we collectively think more and end up agreeing that AUP$_\text{conceptual}$ solves impact measurement, it would be interesting that you could solve such a complex, messy-looking problem in such a simple way. If, however, [CCC](https://www.lesswrong.com/s/7CdoznhJaLEKHwvJW/p/w6BtMqKRLxG9bNLMr) ends up being false, I think that would also be a new and interesting fact not currently predicted by our models of alignment failure modes. [↩︎](#fnref-8dmzMpaWPrC4ygzTz-2)