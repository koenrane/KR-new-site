...
### Don't talk about people getting hurt
...
But we _didn't cache or add in_ the steering vector until layer 20. How is token-level information still present? Even if the  `talk`,  `about`, and  `weddings` embedding-vector directions aren't _deleted_ from the residual stream by layer 20, embedding vectors are [low-norm relative to typical residual streams at Layer 20](https://www.lesswrong.com/posts/8mizBCm3dyc432nK8/residual-stream-norms-grow-exponentially-over-the-forward). 
...
### Adding "Love" without subtracting "Hate"
...
### Sometimes, huge coefficients are OK
...
### Failing to find a French vector
...
### Insert the steering vector at a different position?
...
![](https://res.cloudinary.com/lesswrong-2-0/image/upload/f_auto,q_auto/v1/mirroredImages/5spBue2z2tw4JuDCx/c6www60aod0avcztl6el)
Figure: Adding the steering vector in the _middle_ position. The middle two residual streams are modified.![](https://res.cloudinary.com/lesswrong-2-0/image/upload/f_auto,q_auto/v1/mirroredImages/5spBue2z2tw4JuDCx/czwtzodmb7jqvxq8ayf7)
Figure: Adding the steering vector in the _back_ position.
...
![](https://res.cloudinary.com/lesswrong-2-0/image/upload/f_auto,q_auto/v1/mirroredImages/5spBue2z2tw4JuDCx/vr3rjpqlvnsstkkodojf)
