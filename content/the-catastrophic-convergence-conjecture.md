...
lw-linkpost-url: https://www.lesswrong.com/posts/w6BtMqKRLxG9bNLMr/the-catastrophic-convergence-conjecture
...
prev-post-slug: attainable-utility-landscape-how-the-world-is-changed
...
> [!quote] Paul Christiano, [Scalable AI control](#.1riohnubu)
>
...
6.  When I say "an objective catastrophe destroys _a lot_ of agents' abilities to get what they want", I don't mean that the agents have to actually be present in the world. Breaking a fish tank destroys a fish's ability to live there, even if there's no fish in the tank. [↩︎](#fnref-25bChTEETACfS9a4m-6)
...
8.  [Some large reward function classes are probably not alignable](/against-rewards-over-observations); for example, consider all Markovian linear functionals over a webcam's pixel values. [↩︎](#fnref-25bChTEETACfS9a4m-8)
    
9.  I disagree with my usage of "aligned _almost never_" on a technical basis: assuming a finite state and action space and considering the maxentropy reward function distribution, there must be a positive measure set of reward functions for which the/a human-aligned policy is optimal. [↩︎](#fnref-25bChTEETACfS9a4m-9)