...
![](/static/images/posts/lqrnae8zgs8c8vmvvv34.webp)
...
![](/static/images/posts/lteqnk5fbayr0jixir5z.webp)
...
![](/static/images/posts/h6jet9gvpvaza5mivsyj.webp)
...
![](/static/images/posts/iwodm9z5v0xryx30udsu.webp)
...
![](/static/images/posts/owma6gmkcenaay46qy9j.webp)
...
![](/static/images/posts/c6www60aod0avcztl6el.webp)
<br/>Figure: Adding the steering vector in the _middle_ position. The middle two residual streams are modified.![](/static/images/posts/czwtzodmb7jqvxq8ayf7.webp)
...
![](/static/images/posts/qq8z4qyysjoqovkb2co8.webp)
...
![](/static/images/posts/fz2kgktmqaksca2myyn1.webp)
...
![](/static/images/posts/oonjthtzslo1k05m8gnc.webp)
...
![](/static/images/posts/vjdd7tyygqdjieujtinm.webp)
...
![](/static/images/posts/mdnxpkdk7zczblsl0hx1.webp)
...
| (varies) | \-1 | `<endoftext>` |   |<br/>Table:  Residual stream alignment for activation additions.![](/static/images/posts/xsrxtbmdkr9dftyyrdpj.webp)
...
![](/static/images/posts/vr3rjpqlvnsstkkodojf.webp)
...
![](/static/images/posts/txdkcztwtny3ufawnvoe.webp)
...
![](/static/images/posts/brufvgichbfhjzdfqzkf.webp)
...
| (varies) | (varies) | `<endoftext>` |   |<br/>Table:  Residual stream alignment for activation additions.![](/static/images/posts/lj0kngo33tpns6zq3ijy.webp)
...
![](/static/images/posts/ukwtfadzp6yzaiiczk9w.webp)
...
![](/static/images/posts/olxff6ovpe61is3c3edg.webp)
...
$$
![](/static/images/posts/vk4rniokxj4izqc1e2nw.webp)
...
![](/static/images/posts/mcdkfubnvsfiwlmltdo4.webp)
...
[^30]: We collected a range of other kinds of quantitative results, including e.g. topic-related word counts, blinded human rating, and ChatGPT ratings. The results accorded with our results here: Steering vectors are effective in the examined situations. 
...
[^35]: There are a few late layers where positive reviews have a lower perplexity ratio than neutral reviews, but this seems within noise. 
...
[^39]: From [Understanding and controlling a maze-solving policy network](/understanding-and-controlling-a-maze-solving-policy-network):
...
[^41]: Submarani et al. optimized several steering vectors $\mathbf{z}^i_\text{steer}$ for the same sentence (e.g. "I love dogs"), which were different due to different initialization. When they added in the mean steering vector $\overline{\mathbf{z}}_\text{steer}$, this _also_ generated e.g. "I love dogs".
