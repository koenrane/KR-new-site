...
> 
> - Even if you have to get the human-aligned values "perfectly right" in order to avoid Goodharting (~which I am unsure of~ ETA I [don’t believe this](/alignment-without-total-robustness)), not having to get _all_of the AI's values perfectly right is good news.
...
**Alex (A):** I don’t think it makes sense to design an agent to have an actor/grader motivational structure. [As I’ve discussed](/dont-design-agents-which-exploit-adversarial-inputs), [I think those design patterns are full of landmines](/dont-align-agents-to-evaluations-of-plans). 
