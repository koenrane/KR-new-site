...
_Write down a credence for each of the following behavioral propositions about Lauro’s `rand_region_5` model tested on syntactically legal mazes, **excluding** test mazes where the cheese is within the 5\*5 rand\_region and test mazes that do not have a decision-square:_ 
